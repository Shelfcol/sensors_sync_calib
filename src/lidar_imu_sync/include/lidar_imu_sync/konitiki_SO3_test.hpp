#ifndef KONTIKI_SO3_TEST_HPP_
#define KONTIKI_SO3_TEST_HPP_
...
{
public:
    void ReadImuData(std::string& bag_path, std::string& imu_topic_name)
    {
    ...
    void Test()
    {
        ...
        SaveTumFormat("/home/gxf/multi-sensor-fusion/calib_ws/src/calib_res_vis/data/");
        SaveKittiFormat("/home/gxf/multi-sensor-fusion/calib_ws/src/calib_res_vis/data/");
